 ...
 *
 * Return: pointer to the hash table, or NULL if malloc failed
 */
 ...
 * @value: string to insert at the node
 *
 ...
 * @ht: pointer to the sorted hash table
 * @key: the non-NULL key
 * @value: the value associated with the key or empty string
 *
 * Return: 1 on success, 0 on failure
 */
...
/**
 * shash_table_print - prints key/value pairs in order
